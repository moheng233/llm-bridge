...
import type { CatalogProviderSummary } from "./CatalogProviderSummary";
...
import type { ImportModelsDevRequest } from "./ImportModelsDevRequest";
import type { ImportedProvider } from "./ImportedProvider";
...
export function createApiClient(options: ApiClientOptions) {
  ...
  return {
    admin: {
      ...
      searchModelsDev: () => request<CatalogProviderSummary[]>("/api/v1/admin/models-dev/search", { auth: true }),
      importModelsDev: (body: ImportModelsDevRequest) =>
        request<ImportedProvider>("/api/v1/admin/models-dev/import", { method: "POST", auth: true, body }),
